...
parser.add_argument('--model', type=str, default='LagAttention',
                    help='model name, options: [TimeMixer,LagAttention]')
...
parser.add_argument('--var_num', type=int, default=7, help='num of variable')
...
parser.add_argument('--daytime', type=int, default=48, help='length of gap')
parser.add_argument('--gapdis', type=int, default=12, help='length of gap')
...
parser.add_argument('--channel_independent', type=int, default=0, help='channel_independent')#原25
...
parser.add_argument('--use_kmeans', type=bool, default=True, help='use use_kmeans')
parser.add_argument('--use_single_patch', type=bool, default=False, help='use use_kmeans')
parser.add_argument('--use_delay', type=bool, default=True, help='use delay')
